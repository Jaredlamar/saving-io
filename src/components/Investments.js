            ...
            <Paper sx={{m: 3.5, bgcolor: 'rgba(0,0,0,0.7)'}}>
                <Typography 
                    ...
                    <form onSubmit={monthlyPayment}>
                        ...
                        <TextField name="homePrice" type="number" label="Property Value" color="primary" variant="filled" margin="normal" sx={{width: '90%', ml: 2, background: "#565656"}} onChange={PropertyValueInput} value={formState.homePrice} ></TextField>
